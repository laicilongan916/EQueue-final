...
public class OrganizationActivity extends AppCompatActivity {
    ...
    private String URL_countView = "https://bait2073equeue.000webhostapp.com/update_View.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateViewCount(organization_index);
    ...
    public void updateViewCount(final int position)
    {
        JsonArrayRequest jsonObjectRequest = new JsonArrayRequest(URL_countView + "?ID=" + position,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            {
                                JSONObject OrganizationView = (JSONObject) response.get(i);
                                OrganizationViewCount serverData = new OrganizationViewCount
                                        (OrganizationView.getInt("ID"),
                                                OrganizationView.getInt("totalView"),
                                                OrganizationView.getInt("dailyView"),
                                                OrganizationView.getInt("monthlyView"),
                                                OrganizationView.getInt("anualView"));
                            }
                        } catch (Exception e) {
